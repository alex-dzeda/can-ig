...
| :--- | :--- | :--- | :--- |
| **JWT Standard Claims** | `iss`, `sub`, `aud`, `exp`, `iat`, `jti` | **SHALL** | Standard OAuth/JWT envelope claims identifying the Ticket Issuer, ticket subject, target audience (or Data Holder filter), expiration, and unique ticket identifier. |
